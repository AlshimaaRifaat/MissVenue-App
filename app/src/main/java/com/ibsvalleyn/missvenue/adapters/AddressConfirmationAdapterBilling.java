...
public class AddressConfirmationAdapterBilling extends RadioConFixationAdapter<User_address_model> {
    ...
    String addressIdBilling;
    private EditText city;
    private int addressId;
    private EditText zip1;
    private String zip;

    public String getAddressIdBilling() {
        return addressIdBilling;
    }

    public AddressConfirmationAdapterBilling(CheckOutActivity context, List<User_address_model> profile) {
...
//                addressIdBilling = String.valueOf(profile.get(position).getAddressId());
                dataSaver.edit()
                        .putString("addressIdBilling", String.valueOf(profile.get(position).getAddressId()))
                        .apply();
            }
        });
