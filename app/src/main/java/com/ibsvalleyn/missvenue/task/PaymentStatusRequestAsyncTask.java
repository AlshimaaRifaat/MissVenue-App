...
import com.ibsvalleyn.missvenue.common.Constants;
...
public class PaymentStatusRequestAsyncTask extends AsyncTask<String, Void, String> {
    ...
    private String requestPaymentStatus(String resourcePath) {
        ...
        Log.e("paymentStatus", "paymentStatus1 " + paymentStatus);
        try {
            ...
            Log.e("paymentStatus", "paymentStatus2 " + paymentStatus);
        ...
        Log.e("paymentStatus", "paymentStatus3 " + paymentStatus);
